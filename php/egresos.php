<?php
	...
	$sql = "SELECT f.id_f As No, DATE_FORMAT(f.fecha_f, '%d-%m-%Y') As Fecha, f.hora_f As Hora, s.name_c As Socio,
                    f.concepto_f As Concepto, f.monto_f As Monto, u.name_u As Usuario FROM flujos f 
	...
	$(document).ready(function() {
		$('.tablas').DataTable({
	        ...
	        buttons: [
	            ...
	            {
	                extend: 'excel',
	                messageTop: 'AMIC CD HIDALGO - Relación de egresos Fecha: ' + fecha_actual2()
	            },
	            {
	                extend: 'pdf',
	                messageTop: 'AMIC CD HIDALGO - Relación de egresos Fecha: ' + fecha_actual2()
