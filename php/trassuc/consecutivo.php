<?php
    ...
    */
    ...
    //traspason_tr	fecha_tr	hora_tr	id_u	monto_tr	status_tr	id_s	origen_tr	
    $sql = "INSERT INTO `traspasos`(`traspason_tr`, `fecha_tr`,
                                     `hora_tr`, `id_u`, `monto_tr`, 
                                     `status_tr`, `id_s`, `origen_tr`) 
            VALUES (:venta, NOW(), NOW(), :idu, 0, 0, :sucursal, 0)";
